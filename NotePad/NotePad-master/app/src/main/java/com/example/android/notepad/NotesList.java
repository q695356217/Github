...
public class NotesList extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View layoutView = getLayoutInflater().inflate(R.layout.layout_search, null);
        final EditText mEditTitle = (EditText) layoutView.findViewById(R.id.title);
        Button mBtnSearch = (Button) layoutView.findViewById(R.id.search);
        mBtnSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final String title = mEditTitle.getText().toString().trim();
                String selection = "title LIKE '%" + title + "%'";
                Cursor cursor = managedQuery(
                        getIntent().getData(),            // Use the default content URI for the provider.
                        PROJECTION,                       // Return the note ID and title for each note.
        ...
        //设置背景色
        getListView().setBackgroundResource(R.color.colorGreen);
